...
{
	SDLStaticText::SDLStaticText(SDL_Window * parent, std::string text, int pos_x, int pos_y) : SDLControl(parent, SDL_Rect{ pos_x, pos_y, 0, 0}),
	...
	void SDLStaticText::render(SDL_Renderer * renderer)
	{
		...
		text_renderer::renderText(parent_, text_, textLocationTitle, getTextColor(), font_size_);
	}
